...
(function(global) {
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        //
        //Declaration of callback function that invokes the function buildAndShowHomeHTML,
    ...
    function buildAndShowHomeHTML(categories) {
        ...
        $ajaxUtils.sendGetRequest(
            ...
            function(homeHtml) {
                ...
                // We need only short_name property of categories object
                var chosenCategoryShortName = chooseRandomCategory(categories).short_name;
                console.log(chosenCategoryShortName);

                // TODO: STEP 3: Substitute {{randomCategoryShortName}} in the home html snippet with the
                // chosen category from STEP 2 using insertProperty function for that purpose.
                // WARNING! You are inserting something that will have to result in a valid Javascript
                // syntax because the substitution of {{randomCategoryShortName}} becomes an argument
                // being passed into the $dc.loadMenuItems function.
                // For example, a valid call would look something like this:
                // $dc.loadMenuItems('L')
                var homeHtmlToInsertIntoMainPage = insertProperty(homeHtml,
                    "randomCategoryShortName", "'" + chosenCategoryShortName + "'");

                // TODO: STEP 4: Insert the HTML produced in STEP 3 into the main page
